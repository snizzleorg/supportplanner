...
For example, if `package.json` has `"version": "0.8.0"`, it builds as `v0.8.0`.
...
./build-and-push.sh
```
If `package.json` has `"version": "0.8.0"`, creates and pushes:
- `your-username/support-planner:v0.8.0`
